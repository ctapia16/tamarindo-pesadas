...
const STORAGE_KEY = "tamarindo-pesadas-v2";
...
function buildBatchReportHTML(records: RecordItem[], buyer: string, supplier: string) {
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .totals { margin-top: 24px; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px; }
          .total-card { border: 1px solid #ddd; border-radius: 10px; padding: 14px; background: #fafafa; }
          .title { color: #666; font-size: 13px; margin-bottom: 6px; }
          .number { font-size: 26px; font-weight: bold; }
...
export default function Page() {
  ...
  const printBatchReport = () => {
    ...
    popup.document.open();
    popup.document.write(buildBatchReportHTML(records, buyer, supplier || records[0]?.supplier || ""));
    popup.document.close();
  };

  const addRecord = (options?: { openPreview?: boolean; printAfterSave?: boolean }) => {
    if (isSaving) return;
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-slate-50 px-4 py-6 md:px-8">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-300 bg-white text-slate-800 hover:bg-slate-50"
              ...
              <div className="space-y-3">
                <div className="flex flex-col gap-3 sm:flex-row">
                  <button
                    disabled={isSaving}
                    onClick={() => addRecord()}
                    className="flex-1 rounded-2xl bg-slate-900 px-4 py-3 font-medium text-white transition hover:bg-slate-800 disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-2 rounded-2xl border border-slate-300 bg-white px-4 py-3 font-medium text-slate-800 transition hover:bg-slate-50 disabled:opacity-60"
                  >
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-slate-200 px-4 py-3 font-medium text-slate-900 transition hover:bg-slate-300 disabled:opacity-60"
                  >
